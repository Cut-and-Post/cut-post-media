...
import { PageTemplate, Link, Button, Heading, Row, Column  } from 'components'
      ...
      <div className="container">
        <Row className="mt-5 pt-4">
          ...
          >
            ...
            <Button type="submit" className="btn btn-primary submit-btn">Cut & Post agency</Button>
          </Column>
          <Column
            md={{ span: 6 }}
            className="hp-hero"
          >
            ...
            <Button type="submit" className="btn btn-primary submit-btn">Cut & Post staffing</Button>
          </Column>
        </Row>
      </div>
    </PageTemplate>
